      ...
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            ...
            <p>
              &copy; Investify Broking Ltd. All rights reserved.
            </p>
          </div>
          <div className="col">
            <p>Company</p>
            ...
            <br />
            <a href="" style={{textDecoration:"none"}}>Investify.tech</a>
            <br />
            <a href="" style={{textDecoration:"none"}}>Press & media</a>
            <br />
            <a href="" style={{textDecoration:"none"}}>Investify cares (CSR)</a>
            <br />
          </div>
          <div className="col">
            <p>Support</p>
        ...
        <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
          <p>
            Investify Broking Ltd.: Member of NSE​ &​ BSE – SEBI Registration no.:
            INZ000031633 CDSL: Depository services through Investify Securities
            Pvt. Ltd. – SEBI Registration no.: IN-DP-100-2015 Commodity Trading
            through Investify Commodities Pvt. Ltd. MCX: 46025 – SEBI Registration
            no.: INZ000038238 Registered Address: Investify Broking Ltd.,
            #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School,
            J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any
            complaints pertaining to securities broking please write to
            complaints@Investify.com, for DP related to dp@Investify.com. Please
          ...
          <p>
            ...
            claiming to be part of Investify and offering such services, please
